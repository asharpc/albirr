...
const AddFeePaymentForm = ({ studentFee, children }: Props) => {
  ...
  const methods = useForm<FormData>({
    defaultValues: {
      amount: studentFee.pending_amount,
      payment_method: "",
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Record payment for {studentFee.student.first_name} {studentFee.student.last_name} - {studentFee.fee_type_display}
          </DialogDescription>
        </DialogHeader>
                ...
                <FormControl>
                  <Input
                    ...
                    {...methods.register("amount", {
                      ...
                      max: { value: studentFee.pending_amount, message: "Amount cannot exceed pending amount" },
                    })}
                  />
                </FormControl>
                <FormMessage />
